...
Me gustaría cotizar algo similar. ¿Podrían ayudarme con los detalles y precios?`
  ...
  const productos = [
    ...
    {
      id: 7,
      nombre: "Torta Flores Buttercream",
      categoria: "buttercream",
      descripcion: "Hermosa torta decorada con flores de buttercream en tonos pastel",
      imagen: "/placeholder.svg?height=300&width=300",
      tags: ["Flores", "Pastel", "Romántica"],
    },
    {
      id: 8,
      nombre: "Torta Ombré",
      categoria: "buttercream",
      descripcion: "Torta con efecto degradado en buttercream de rosa a blanco",
      imagen: "/placeholder.svg?height=300&width=300",
      tags: ["Ombré", "Rosa", "Moderno"],
    },
    {
      id: 9,
